    ...
    <div class="py-12">
        <div
            ...
            <div class="container mx-auto">
                <form class="block w-full" method="POST" action="{{ url('/admin/cars/update/'.$data->cars_id) }}"
                    ...
                    <div class="flex flex-wrap -mx-3 mb-4">
                        <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                            ...
                            <x-text-input id="brand" class="block mt-1 w-full" type="text" name="brand"
                                value="{{ $data->brand }}" required autofocus autocomplete="brand" />
                        ...
                        <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                            ...
                            <x-text-input id="model" class="block mt-1 w-full" type="text" name="model"
                                value="{{ $data->model }}" required autofocus autocomplete="model" />
                        ...
                        <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                            ...
                            <x-text-input id="number_plate" class="block mt-1 w-full" type="text" name="number_plate"
                                value="{{ $data->number_plate }}" required autofocus autocomplete="number_plate" />
                    ...
                    <div class="flex flex-wrap -mx-3 mb-4">
                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            <x-text-input id="price_per_day" class="block mt-1 w-full" type="number"
                                name="price_per_day" value="{{ $data->price_per_day }}" required autofocus
                                autocomplete="price_per_day" min="0" />
                            <x-input-error :messages="$errors->get('price_per_day')" class="mt-2" />
                        </div>
                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            <x-input-label for="car_photo_new" :value="__('Car Photo')"
                                class="block tracking-wide text-gray-700 text-sm font-bold mb-2" />
                            <input type="file" name="car_photo_new"
                                class="file-input file-input-md file-input-bordered block mt-1 w-full"
                                autofocus autocomplete="car_photo_new" />
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-300" id="file_input_help">PNG, JPG
                                or JPEG (MAX. 2MB).</p>
                            <input type="text" name="car_photo" value="{{ $data->car_photo }}" hidden>
                            <x-input-error :messages="$errors->get('car_photo_new')" class="mt-2" />
                        </div>
                    </div>
                    <div class="flex flex-wrap -mx-3 mb-4">
                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            <textarea id="editor" name="description" required autocomplete="description"
                                ...
                                dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">{{ $data->description }}
                            </textarea>
                            <x-input-error :messages="$errors->get('description')" class="mt-2" />
                        </div>
                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            <x-ahref.submit-button class="btn btn-md btn-warning">
                                <p class="text-md font-bold">Update</p>
