                    ...
                    <tbody>
                        @foreach ($data as $datas)
                            <tr
                                ...
                                <td class="px-4 py-4">
                                    @if ($datas->payment_status == 'unpaid' && $datas->admin_check == true)
                                        <form method="POST"
                                            action="{{ url('/admin/transaction-data/validate/' . $datas->transaction_id) }}">
                                            @csrf
                                    ...
                                    @else
                                        ...
                                        @elseif ($datas->payment_status == 'paid' && $datas->tracking_status == 'ongoing' && $datas->admin_check == false)
                                            <div class="text-center">-</div>
                                        @elseif ($datas->payment_status == 'unpaid' && $datas->tracking_status == 'waiting')
                                            <div class="text-center">-</div>
                                        @elseif ($datas->payment_status == 'paid' && $datas->tracking_status == 'ongoing' && $datas->admin_check == true)
                                            <form method="POST"
                                                action="{{ url('/admin/transaction-data/return-validate/' . $datas->transaction_id) }}">
                                                @csrf
                                                <x-ahref.submit-button data-confirm-delete="true"
